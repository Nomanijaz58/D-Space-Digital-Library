...
public class SystemWideAlert implements ReloadableEntity<Integer> {
    ...
    /**
     * This method returns the ID that the system-wide alert holds within the
     * database
     *
    ...
    /**
     * Retrieve what kind of sessions are allowed while the system-wide alert is
     * active
     *
     * @return what kind of sessions are allowed while the system-wide alert is
     *         active
     */
    ...
    /**
     * Retrieve the date to which will be count down when the system-wide alert is
     * active
     *
     * @return the date to which will be count down when the system-wide alert is
     *         active
     */
